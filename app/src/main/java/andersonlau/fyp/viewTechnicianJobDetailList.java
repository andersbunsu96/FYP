...
public class viewTechnicianJobDetailList {
    private String jobID, imageURL, message, userID, username_technician;

    public viewTechnicianJobDetailList(String jobID, String imageURL, String message, String userID, String username_technician) {
        this.jobID = jobID;
