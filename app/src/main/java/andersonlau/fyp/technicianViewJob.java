...
public class technicianViewJob extends AppCompatActivity {
    ...
    private void loadProducts() {
        ...
        String URL_PRODUCTS = "https://integratedcustomerinfomationsystem.000webhostapp.com/getJobTechnician.php?username_technician="+ username_technician;
