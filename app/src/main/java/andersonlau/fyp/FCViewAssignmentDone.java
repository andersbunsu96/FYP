...
public class FCViewAssignmentDone extends AppCompatActivity {
    ...
    private void loadProducts() {
        ...
        String URL_PRODUCTS = "https://integratedcustomerinfomationsystem.000webhostapp.com/getFCViewAssignmentDone.php?username_fc="+ username_fc;
