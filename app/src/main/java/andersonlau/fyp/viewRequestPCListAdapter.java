...
public class viewRequestPCListAdapter extends RecyclerView.Adapter<viewRequestPCListAdapter.HistoryViewHolder> {
    private Context mCtx;
    private List<viewRecordedRequestList> productList;
    String id;

    public viewRequestPCListAdapter(Context mCtx, List<viewRecordedRequestList> productList) {
        this.mCtx = mCtx;
    ...
    @Override
    @NonNull
    public viewRequestPCListAdapter.HistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.rv_view_recorded_request, parent, false);
        return new viewRequestPCListAdapter.HistoryViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull viewRequestPCListAdapter.HistoryViewHolder holder, int position) {
    ...
    class HistoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(mCtx, recordedRequestDetailPC.class);
