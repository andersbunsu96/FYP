...
public class recordedRequestDetailPC extends AppCompatActivity implements View.OnClickListener {

    TextView tvRequestTitle, tvClientName, tvLocation, tvRequestDescription, tvUsername, tvRID;
    String RID = "", location = "", clientName = "", requestTitle = "", requestDescription = "", username ="", jobDone = "", assignmentSent="";
    Button btnSend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recorded_request_detail_pc);
    ...
    private void loadDetail() {
        ...
        String URL_PRODUCTS = "https://integratedcustomerinfomationsystem.000webhostapp.com/recordedRequestDetailPC.php?RID=" + RID;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                assignmentSent = response1.getString("assignmentSent");
    ...
    private void loadFromSite()
    {
        ...
        if (jobDone.equals("Yes") || assignmentSent.equals("Yes")){btnSend.setVisibility(View.GONE);}
    }
    ...
    public void onClick(View v) {
        ...
        Toast.makeText(this, "Cannot send assignment anymore as job already done", Toast.LENGTH_SHORT).show();}

        else if (assignmentSent.equals("No")) {
            Intent intent = new Intent(this, PCSendAssignment.class);
            intent.putExtra("RID", RID);
            intent.putExtra("requestTitle", requestTitle);
            intent.putExtra("requestDescription", requestDescription);
            finish();
