...
public class PCViewAssignmentList {
    private String ID, RID, assignmentName, assignmentDesc, FOD_approved, jobCreated;

    public PCViewAssignmentList(String RID, String assignmentName, String assignmentDesc, String ID, String FOD_approved, String jobCreated) {
        this.RID = RID;
